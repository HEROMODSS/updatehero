...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Heroupdate" },
      { name: "description", content: "Dialog Updater allows developers to dynamically control app update dialogs." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Heroupdate" },
      { property: "og:description", content: "Dialog Updater allows developers to dynamically control app update dialogs." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Heroupdate" },
      { name: "twitter:description", content: "Dialog Updater allows developers to dynamically control app update dialogs." },
